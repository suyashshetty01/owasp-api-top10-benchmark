...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "email":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Cristobal.Weissnat@example.com"]),
    primitives.restler_static_string(""",
    "name":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Cristobal.Weissnat"]),
    primitives.restler_static_string(""",
    "number":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["6915656974"]),
    primitives.restler_static_string(""",
    "password":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["5hmb0gvyC__hVQg"]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "email":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["test@example.com"]),
    primitives.restler_static_string(""",
    "password":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Test!123"]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "email":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["adam007@example.com"]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "otp":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["9969"]),
    primitives.restler_static_string(""",
    "password":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["5hmb0gvyC__hVQg"]),
    primitives.restler_static_string(""",
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "new_email":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Sofia.Predovic@example.com"]),
    primitives.restler_static_string(""",
    "old_email":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Cristobal.Weissnat@example.com"]),
    primitives.restler_static_string("}"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "old_email":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Einar.Swaniawski@example.com"]),
    primitives.restler_static_string(""",
    "new_email":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Danielle.Ankunding@example.com"]),
    primitives.restler_static_string(""",
    "token":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["T9O2s6i3C7o2E8l7X5Y4"]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "pincode":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["9896"]),
    primitives.restler_static_string(""",
    "vin":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["0IOJO38SMVL663989"]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "content":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Est maiores voluptas velit. Necessitatibus vero veniam quos nobis."]),
    primitives.restler_static_string(""",
    "title":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Velit quia minima."]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "content":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Porro aut ratione et."]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "coupon_code":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["TRAC075"]),
    primitives.restler_static_string(""",
    "amount":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["75"]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "name":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["WheelBase"]),
    primitives.restler_static_string(""",
    "price":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["10.12"]),
    primitives.restler_static_string(""",
    "image_url":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["http://example.com/wheelbase.png"]),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_fuzzable_string("fuzzstring", quoted=False, examples=["TRAC_MECH1"]),
    primitives.restler_static_string("&"),
    primitives.restler_static_string("problem_details="),
    primitives.restler_fuzzable_string("fuzzstring", quoted=False, examples=["My car has engine trouble, and I need urgent help!"]),
    primitives.restler_static_string("&"),
    primitives.restler_static_string("vin="),
    primitives.restler_fuzzable_string("fuzzstring", quoted=False, examples=["0BZCX25UTBJ987271"]),
    primitives.restler_static_string(" HTTP/1.1\r\n"),
    primitives.restler_static_string("Accept: application/json\r\n"),
    primitives.restler_static_string("Host: localhost:8888\r\n"),
    primitives.restler_refreshable_authentication_token("authentication_token_tag"),
